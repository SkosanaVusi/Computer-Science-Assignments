...
public class BinaryTree<dataType>
{
   ...
   */
   ...
   /**
   * Prints height of the BinaryTree
   * @param node
   ...
   */
   ...
   /**
   * Prints all the nodes in the Binary Tree with the parent nodes in between the children nodes
   * @param node
   * A node to start trasnversing from to down the tree.
   *
   */
   ...
   /**
   * Prints all the nodes in the Binary Tree staring from the parent node to the children nodes
